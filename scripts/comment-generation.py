...
if __name__ == "__main__":
    ...
    if added_snapshots:
        ...
        for img in sorted(added_snapshots):
            ...
            print("")
            new_image = f'https://github.com/murzagalin/android-snapshot-testing/blob/{commit_hash}/new/{img}?raw=true'
    ...
    if removed_snapshots:
        ...
        for img in sorted(removed_snapshots):
            ...
            print(f'<summary>{file_name}</summary>')
            print("")
            old_image = f'https://github.com/murzagalin/android-snapshot-testing/blob/{commit_hash}/old/{img}?raw=true'
